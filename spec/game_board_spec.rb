...
describe GameBoard do
  ...
  it 'can validate an up diagonal win' do
    game_board = GameBoard.new
    ...
    game_board.e_cells[:e5] = "0"
    game_board.f_cells[:f6] = "0"

  expect(game_board.up_diagonal_win?).to eq(true)
  end
  ...
  xit 'can validate a down diagonal win' do
    game_board = GameBoard.new
  ...
  expect(game_board.down_diagonal_win?).to eq(true)
  end
end
